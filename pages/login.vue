    ...
    <div class="login__page">
        ...
        <div class="mx-auto login__container" max-width="240">
            ...
            <form class="login__form" @click.prevent>
                ...
                />
                <button
                    v-if="!isForgotPassword && !isSignUp && !nextStep"
                    class="login__btn"
                    @click="login"
                >
                    Login
            ...
            <button v-if="isSignUp" class="login__btn" @click="setNextStep">
                Next step
            </button>
            <button
                v-if="nextStep"
            ...
            <div v-if="!isForgotPassword && !nextStep" class="login__section">
                ...
                <div class="socials__container">
                    ...
                    /></a>
                    <a href="#"
                        ><img src="../static/socials/blizard.png" alt="blizard"
                    /></a>
                    <a href="#"
                        ><img src="../static/socials/google.png" alt="google"
                    /></a>
                    <a href="#"
                        ><img src="../static/socials/steam.png" alt="steam"
                    /></a>
                </div>
            </div>
            <div class="register__section">
                ...
                <p v-if="!isForgotPassword && !isSignUp && !nextStep">
...
export default {
    ...
    methods: {
        ...
        setSignUpStep() {
            if (this.$route.params.signUp !== undefined) {
                this.isSignUp = this.$route.params.signUp
            } else {
                return null
            }
        },
